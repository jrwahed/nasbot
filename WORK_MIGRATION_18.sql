-- ============================================================================
-- WORK_MIGRATION_18.sql — اسم المكان ما يبانش قبل الدفع
--
-- بعد ما اتشالت قايمة الأماكن من اللوحة، اسم مكان سبوطة نسبوط بقى بيتكتب في
-- `venue_name_ar` — والفيو العام بيطلّعه للكل. الملف ده بيقفله على خروجات
-- الأعضاء بس (وهي مقصودة).
--
-- بعده: select * from test_venue_name_privacy();
-- ============================================================================

-- ############################################################################
-- # 20260913110000_0097_venue_name_member_only.sql
-- ############################################################################
