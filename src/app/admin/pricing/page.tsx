    ...
    <>
      ...
      >
        <div className="mt-3 font-body text-15 leading-[1.9]">
          ...
          <b>إنك تحطّ المسبوط في جروب ناس جداد متوافقين، وتضمنله إن القعدة تطلع حلوة.</b>{' '}
          ده «رسم الموقع» — وهو <code>org_fee</code> في القاعدة، وبيتظبط لكل قالب من صفحة القوالب. (كان اسمه «رسوم التنظيم والكابتن» — الكابتن ما بقاش أساس المنتج، والعضو بيظبّط الميعاد والمكان بنفسه.)
        </div>
        <div
