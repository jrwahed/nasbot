...
const WORK_GROUPS: { title: string; nums?: WorkNumSpec[]; times?: WorkTimeSpec[] }[] = [
  ...
  },
  {
    ...
    times: [
      {
        col: 'work_lunch_at',
        label: 'ساعة الغدا (الافتراضي)',
        hint: 'بتظهر في جدول يوم الشغل. دي القيمة الافتراضية — أي قالب سبوطة محدد فيه ساعة غدا بيغلبها.',
      },
      {
        col: 'work_complaint_at',
        label: 'ساعة الشكوى (الافتراضي)',
        hint: 'الوقفة اللي كل واحد بيقول فيها إيه اللي معطّله. برضه افتراضي — قالب السبوطة بيغلبه لو حدّد.',
      },
    ],
  },
  {
