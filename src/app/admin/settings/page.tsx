...
const GROUPS: Group[] = [
  {
    /*
      ⚠ **المجموعة دي بتقفل الموقع على الناس — اقراها قبل ما تلمسها.**
        كل مفتاح هنا بيمنع ناس من الحجز. وكلهم مقفولين من يوم ما اتعملوا،
        يعني الوضع الافتراضي إن النادي مفتوح.

        الأدمن مستثنى من البوابة في القاعدة (`fn_gate_state`)، فمهما فتحت
        مفاتيح انت مش هتتقفل بره موقعك.
    */
    title: 'بوابة الدخول',
    picks: [
      {
        col: 'gate_invite_only',
        label: 'الدخول بالدعوة بس',
        hint: 'محدش يحجز من غير كود من عضو جوه. كل عضو مقبول بياخد عدد دعوات — الرقم تحت.',
        bool: true,
        options: [
          { value: 'false', label: 'مفتوح للكل' },
          { value: 'true', label: 'بالدعوة بس' },
        ],
      },
      {
        col: 'gate_needs_approval',
        label: 'كل عضو جديد يستنى موافقتك',
        hint: 'العضو بيسجّل عادي بس ما يحجزش غير لما تقبله من «الناس ← طلبات الدخول».',
        bool: true,
        options: [
          { value: 'false', label: 'يحجز على طول' },
          { value: 'true', label: 'يستنى موافقتك' },
        ],
      },
    ],
    nums: [
      {
        col: 'gate_needs_endorsements',
        label: 'تزكيات مطلوبة',
        hint: 'كام عضو موجود لازم يقول إنه يعرفه قبل ما يحجز. صفر = مش مطلوبة.',
        suffix: 'تزكية',
        min: 0,
        max: 5,
      },
      {
        col: 'invites_per_member',
        label: 'دعوات لكل عضو',
        hint: 'العضو بياخد الرقم ده أول ما يتقبل. تقدر تقفل دعوات حد بعينه من «الناس».',
        suffix: 'دعوة',
        min: 0,
        max: 50,
      },
