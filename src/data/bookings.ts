...
/*
 * ⚠ `reviewQuestions` اتشالت من هنا. كانت نصوص معروضة في ملف بيانات عرض،
 *   وكانت **هي نفسها مفتاح التخزين** في القاعدة — فأي تعديل في الكلام كان
 *   بيضيّع الدرجات بالكامل بالصمت. بقت في `src/lib/review-fields.ts`
 *   (مفتاح ثابت + عمود) والنص في `copy_strings`.
 */
