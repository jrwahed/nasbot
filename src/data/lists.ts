...
/**
 * ⚠ **احتياطي بس — مش مصدر الحقيقة.**
 *
 * القواعد الخمسة والضمان بقوا فقرات في `content_blocks` (هجرة 0082)، والموقع
 * بيقراهم من `useNumberedRules()` و`useContentRef('guarantee')`. القيم هنا
 * اتنسخت في `src/data/content-fallback.ts` وهي اللي بتشتغل لو القاعدة وقعت.
 *
 * متضفش عليهم ولا تعدّلهم هنا — التعديل من `/admin/content` ← «صفحات الموقع».
 * سايبينهم في الملف ده لأن `check-copy` بيعتبر `src/data` نصوص احتياطية.
 */
...
/** نص الضمان — احتياطي. المصدر `content_blocks` بمرجع `guarantee`. */
export const guaranteeText =
  'لو إحنا لغينا، فلوسك كاملة. لو أنت لغيت قبل 3 أيام، فلوسك كاملة. أقل من كده، رصيد.'

/** روابط الذيل — [ملف] */
export const footerLinks = ['القواعد', 'الأسئلة', 'افتح خروجة', 'مين إحنا', 'الشروط']

/** سطر الذيل — [ملف] */
export const footerLine = 'نسبوط — نادي خروجات في القاهرة. مفيش عضوية.'

/** الشريط المتحرك — [ملف] حرفيًا */
// ⚠ كان بيسمّي سبوطات وأرقام أماكن **مخترعة** وثابتة. بقى عام — ما يكدبش
//   على حد، وما يحتاجش تعديل كل أسبوع.
export const marqueeText =
  'كل أسبوع خروجات جديدة · اختار اللي يعجبك · احجز · مجموعتك تتكشف قبلها بيوم ▸ '
...
/** الاقتباس — [ملف] */
// ⚠ كان اقتباس **مخترع منسوب لشخص اسمه نور**. اتشال. ده سطر من نسبوط
//   نفسه مش كلام حد. لو جه اقتباس حقيقي من عضو راح فعلًا، يتحط مكانه
