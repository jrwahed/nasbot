-- ============================================================================
-- الجزء ٢ من ٢ — طبقة «الشغل»
--
-- ⚠ شغّل الجزء ١ الأول. لو شغّلت ده قبله هيقول:
--     unsafe use of new value "cafe_work" of enum type venue_kind_t
--
-- ده الجداول والدوال والسياسات والبذرة والمهام المجدولة (الهجرات 0040 → 0046).
-- آمن يتكرر — كله if not exists / create or replace / on conflict.
--
-- بعد ما يخلص، شغّل ده للتأكد:      select * from test_work_rls();
-- لازم كل الصفوف تطلع «نجح».
-- ============================================================================
