...
### 5.1ب الدخول بإيميل وباسورد — إعداد واحد لازم

الدخول في الموقع واللوحة بـ **إيميل + باسورد** عند سوبابيس مباشرة (مفيش رمز).
لازم تقفل تأكيد الإيميل وإلا التسجيل هيستنى رسالة تأكيد مش هتوصل لحد:

Supabase ← **Authentication ← Sign In / Providers ← Email**:
- **Confirm email**: ⛔ **OFF**
- **Enable email provider**: ✅ ON
- Minimum password length: 6 (الافتراضي)

اتأكد بعدها: افتح `/join`، سجّل بإيميل جديد، لازم تدخل فورًا من غير أي رسالة.
