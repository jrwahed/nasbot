-- ============================================================================
-- جدولة الإشعارات — pg_cron بينده /api/cron/work-notify كل ٥ دقايق
--
...
-- كل ٥ دقايق. المسار بياخد 20 صف بالكتير في النداء الواحد.
--
-- ⚠ كانت **كل ساعة عند الدقيقة 5**، وده كان بيتأخّر على الرسايل اللي
--   بتتولد في أي وقت مش على رأس الساعة. مقاس من الإنتاج: إيميل «مكانك
--   محجوز» اتولد 11:36 واتبعت **12:05** — ٢٩ دقيقة. و«مجموعتك ظهرت»
--   (بتتولد من `job_reveal_due` كل ١٠ دقايق) كانت ممكن تستنى قرب ساعة،
--   وهي بالظبط اللحظة اللي الطقس كله متعلّق بيها.
--   التذكيرات كانت شكلها تمام (٥ دقايق) لأنها بتتولد على رأس الساعة
--   بالصدفة — يعني الرقم كان بيكدب علينا.
