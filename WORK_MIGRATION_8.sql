...
--   0080  العضو يشوف الأماكن علشان يختار مكان خروجته — بدالة ضيّقة بترجّع
--         الاسم والنوع والمنطقة بس. جدول `venues` نفسه فضل مقفول على
--         الإدارة علشان سعر الجملة والعنوان والتليفون ما يتسرّبوش.
--   0081  ٥٢ نص للشاشتين الجداد في `copy_strings` — علشان تتعدّل من
--         /admin/content زي أي نص. الموقع شغّال من غيرها بالاحتياطي.
--
...
--     select * from test_venue_options();
--     select * from test_host_copy();
--
...
-- ############################################################################
-- # 20260912100200_0080_venue_options_for_members.sql
-- ############################################################################
